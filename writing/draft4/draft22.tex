...
\begin{center}
\begin{threeparttable}
\caption{\label{CV}	Leave-one-out cross validation: Mean absolute prediction error divided by IQR}
\linespread{1.3}
...
\br
\\[-1em]
\textbf{Sample:}&\textbf{All covariates\tnote{a}}&\textbf{Only seasonal\tnote{b}}&\textbf{Naive forecast\tnote{c}}\\
\hline
...
\end{indented}
 \begin{tablenotes}
  \begin{footnotesize}
  \item[a] Mixed effects models: the preferred specification with all fixed effects presented in table~\ref{MainEst}.
