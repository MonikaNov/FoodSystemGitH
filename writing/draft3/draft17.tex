...
The estimates of the model based on all the Kenyan counties are summarised in the first two columns of table~\ref{MainEst}. Consistently with our assumptions, seasonal precipitation and average temperature have significant effect on yields. As we expected, the effect of temperature is negative. The linear term of precipitation is positive while the squared term is negative and as we can see in figure~\ref{MarEff1}(a), the marginal effect of precipitation is hill-shaped 
