...
In this study, we analyzed the relationship between maize yields and climate. Our dataset consisted of an yearly panel of $47$ counties of Kenya describing the period of $1981-2017$. 
	...
	In order to proceed with the analysis, the daily weather data had to be converted to an yearly, county-level panel to correspond with the yield data. The first step of this procedure was averaging the gridded weather data over the counties of Kenya resulting in daily time series for each county. In the next step, we aggregated the resulting county level time series temporally to obtain yearly time series. We only considered weather data during the rainy seasons which we defined as follows, using the classification of...
