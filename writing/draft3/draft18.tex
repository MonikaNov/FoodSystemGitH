...
To sum up, in the ASAL counties temperature is much more important than in the non-ASAL counties where temperature is not significant. On the other hand, precipitation is not significant in the ASAL counties while it is strongly significant in the non-ASAL counties. This is illustrated by figure~\ref{MarEff1}. The plot of the marginal effects of precipitation is almost flat for the ASAL counties (figure \ref{MarEff1}(b)) while is steep and hill-shaped for the non-ASAL counties similarly as in the case of the whole sample. As one can see in figures~\ref{MarEff1}(d) and~\ref{MarEff1}(f), the marginal effects of temperature are linear and decreasing for the case of ASAL and non-ASAL counties. Marginal effects of the remaining predictors of the models for the two subsamples are depicted in figures~\ref{MarEff2}(c)-(f) and~\ref{MarEff3}(c)-(f) in the appendix.
