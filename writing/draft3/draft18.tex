...
Besides cumulative seasonal precipitation and average temperature, CV of both temperature and precipitation and also length and number of dry spells were significant (see the first column of table~\ref{MainEst}). As it is apparent from figures~\ref{MarEff2}(a) and \ref{MarEff2}(b) in the appendix, the relationship of maize yield and each of these variables is linear. In accordance with our expectation, the yield decreases with increasing CV of precipitation. \hl{However, the result which we found for CV of temperature is a bit peculiar as the yield seem to increase with increasing variability of temperature. This is probably because...}
...
We will now discuss and compare the results of the models for the subsamples of the ASAL counties (the third and fourth columns of table~\ref{MainEst}) and the non-ASAL counties (the fifth and sixth columns of table~\ref{MainEst}). As for the subsample of the ASAL counties, the only significant fixed effects included average seasonal temperature and length and number of dry spells, all of which were negative. Interestingly, different predictors were  found significant for the subsample of the non-ASAL counties. These included seasonal precipitation and its square (the first one was positive and the second one negative..\textcolor {red}{here}. )
