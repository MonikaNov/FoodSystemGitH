...
\br
\\[-1em]
\textbf{Error autocorrelation structure}&\textbf{AIC}&\textbf{Likelihood ratio}&\multicolumn{1}{c}{\textbf{p-value}}\\
\mr
\textit{None}& $2205.1$& & \\
ARMA($1$,$0$)& $2129.2$& $77.9$&$<1\times10^{-4}$ \\
ARMA($0$,$1$)&  $2144.9$& & \\
\rowcolor{Gray}ARMA(${1}$,${1}$)& ${2122.2}$&${24.7}$&${<1\times10^{-4}}$ \\
ARMA($2$,$1$)& $2124.0$&$\00.1$&$\0\00.7066$ \\
ARMA($1$,$2$)&  $2124.2$& & \\
ARMA($2$,$2$)&$2125.8$& $\00.3$&$\0\00.5681$ \\
ARMA($3$,$2$)& $2128.0$& $\00.1$&$\0\00.7312$ \\
ARMA($2$,$3$)&  $2127.6$& & \\
