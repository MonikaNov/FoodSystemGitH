...
Following the procedure described above, we calculated a number of previously used characteristics of precipitation and temperature. Only some of them were found significant predictors of maize yield. These include: Total seasonal precipitation and 
...
\item relative importance of the individual variables and its measure
