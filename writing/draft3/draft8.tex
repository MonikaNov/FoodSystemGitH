...
Following the procedure described above, we calculated a number of previously used characteristics of precipitation and temperature. Only some of them were found significant predictors of maize yield. These include: Total seasonal precipitation and its squared values, average seasonal temperature, coefficient of variation of seasonal precipitation, standard deviation of average seasonal temperature,  maximum length of dry spell in number of days, the number of dry spell lasting for four days or more

We did not include squared values of the average seasonal temperature as it was not significant.
