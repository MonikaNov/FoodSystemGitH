...
% soubor Know435InOut.R  Know535InOutKm2.R 
\label{ClimKnowInOut} 
\centering
\begin{small}
\vspace{-1.35cm}
...
\hline \vspace{-0.33cm}
  \\
\vspace{-0.33cm}Income - predicted (mill. \textsterling~/yr.)&$-0.273$&$1.000$&\multicolumn{2}{c}{\textit{Not included}}\\ %income PREDICTED!!
  \\
\vspace{-0.33cm}Income - reported (mill. \textsterling~/yr.)\tnote{a}&\multicolumn{2}{c}{\textit{Not included}}&\textit{varies}&$1.000$\\ %income PREDICTED!!
  \\
\vspace{-0.33cm}Net assets (mill. \textsterling)&$0.026$&$1.000$&$0.020$&$1.000$\\ 
      \\
\vspace{-0.33cm}People per mill. km\textsuperscript{2}-LSOA level&\multirow{1}{*}{$1.416$}&\multirow{1}{*}{$1.000$}&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}\\%ha is a symbol for hectares
  \\
\vspace{-0.33cm}People per mill. km\textsuperscript{2}-LAD level&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}&\multirow{1}{*}{$0.254$}&\multirow{1}{*}{$1.000$}\\%ha is a symbol for hectares
  \\
...
% soubor Ccare435InOutb.R  Ccare535InOutbKM2.R
\label{ClimCareInOut} 
\centering
\begin{small}
\vspace{-1.2cm}
...
\vspace{-0.33cm}Climate knowledge\tnote{a}&$-0.187$&$<2\times10^{-8}~^{***}$&$-0.182$&$<2\times10^{-8}~^{***}$\\
  \\
 Redistribution of income:&\multirow{2}{*}{$0.297$}&\multirow{2}{*}{$1.000$}&  \multirow{2}{*}{$0.298$}&\multirow{2}{*}{$1.000$}  \\%-1
    \vspace{-0.33cm}   \hspace{0.6cm}disagree\tnote{b}&&&&\\%-1
    \\
  \vspace{-0.33cm}Redistribution of inc.: neutral\tnote{b}&$0.256$&$1.000$ &$0.263$&$1.000$\\%0
    \\
  \vspace{-0.35cm}Redistribution of income: agree\tnote{b}&$0.778$&$2\times10^{-7}~^{***}$&$0.806$&$8\times10^{-8}~^{***}$\\%1
    \\
  Redistribution of income:& \multirow{2}{*}{$0.937$}&\multirow{2}{*}{$<2\times10^{-8}~^{***}$}&\multirow{2}{*}{$0.939$}&\multirow{2}{*}{$<2\times10^{-8}~^{***}$}\\
\hspace{0.6cm}strongly agree\tnote{b}&&&\\%2
\hline\vspace{-0.33cm}
  \\
\vspace{-0.33cm}Income- predicted (mill. \textsterling~/yr.)&$2.760$&$1.000$&\multicolumn{2}{c}{\textit{Not included}}\\ %income PREDICTED!!
  \\
\vspace{-0.33cm}Income- reported (mill. \textsterling~/yr.)\tnote{c}&\multicolumn{2}{c}{\textit{Not included}}&\textit{varies}&$1.000$\\ %income PREDICTED!!
  \\
\vspace{-0.33cm}Net assets (million \textsterling)&$-0.163$&$1.000$&$-0.310$&$1.000$\\ 
      \\
\vspace{-0.33cm}People per mill. km\textsuperscript{2}-LSOA level&\multirow{1}{*}{$9.838$}&\multirow{1}{*}{$1.000$}&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}\\%ha is a symbol for hectares
  \\
  \vspace{-0.33cm}People per mill. km\textsuperscript{2}-LAD level&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}&\multirow{1}{*}{$-6.520$}&\multirow{1}{*}{$1.000$}\\%ha is a symbol for hectares
  \\
...
% soubor Cpol435InOutb.R  Cpol535InOutbKM2.R
\label{ClimPolInOut} 
\centering
\begin{small}
\vspace{-1.2cm}
...
\hline
  \\
\vspace{-0.33cm}Income- predicted (mill. \textsterling~/yr.)&$2.446$&$1.000$&\multicolumn{2}{c}{\textit{Not included}}\\ %income PREDICTED!!
  \\
...
\vspace{-0.33cm}Net assets (million \textsterling)&$-0.070$&$1.000$&$0.027$&$1.000$\\ 
      \\
\vspace{-0.33cm}People per mill. km\textsuperscript{2}-LSOA level&\multirow{1}{*}{$-16.683$}&\multirow{1}{*}{$1.000$}&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}\\%ha is a symbol for hectares
  \\
\vspace{-0.33cm}People per mill. km\textsuperscript{2}-LAD level&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}&\multirow{1}{*}{$15.548$}&\multirow{1}{*}{$1.000$}\\%ha is a symbol for hectares
  \\
...
\vspace{-0.33cm} \hspace{0.6cm}(ring measure)&& &\\%2
 ...
 \vspace{-0.33cm}Discount rate yr. from now - sq.\tnote{c}&\multirow{1}{*}{$2\times10^{-6}$}&\multirow{1}{*}{$1.000$}&\multirow{1}{*}{$2\times10^{-6}$}&\multirow{1}{*}{$1.000$}\\
  \\  \vspace{-0.33cm}Risk aversion coefficient\tnote{d}&\multicolumn{2}{c}{\textit{Not included}}&$-0.523$&$1.000$\\          
   \\
  \vspace{-0.35cm}Redistribution of income (categ.)\tnote{e}&\textit{$+$,varies}&$1.000$&\textit{$+$,varies}&$1.000$\\%1
    \\
     \hline
...
% soubor Gas435InOut3.R a %Gas535InOutKm2b.R
% % soubor Gas435InOut5.R a %Gas535InOutKm2c.R jeste to odhaduju znovu a davam tam ty kategoricky jako scale, jen abych vedela jestli muzu napsat negative/positive correlation
...
\\
\hline
  \multicolumn{1}{l}{}&\multicolumn{2}{c}{\textbf{Model} $\boldsymbol{1}$}% Gas435InOut3.R
  &\multicolumn{2}{c}{\textbf{Model} $\boldsymbol{2}$}\\%Gas535InOutKm2b.R
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
  \multicolumn{1}{l}{} & \multicolumn{1}{c}{\textbf{Aggreg.}}& \multicolumn{1}{c}{\textbf{Aggreg.}}& \multicolumn{1}{c}{\textbf{Aggreg.}} &  \multicolumn{1}{c}{\textbf{Aggreg.}} \\
...
\hline \vspace{-0.345cm}\\
\vspace{-0.345cm}Income- predicted (thousand \textsterling/yr.)&$0.703$&$3\times10^{-5}~^{***}$&\multicolumn{2}{c}{\textit{Not included}}\\ %income PREDICTED!!
  \\
\vspace{-0.345cm}Income- reported (mill. \textsterling/yr.)\tnote{a}&\multicolumn{2}{c}{\textit{Not included}}&$+$,\textit{varies}&$1.000$\\ %income PREDICTED!!
  \\
\vspace{-0.345cm}Net assets (million \textsterling)&$18.033$&$0.133$&$20.072$&$0.151$\\ 
      \\
\vspace{-0.345cm}People per mill. km\textsuperscript{2}-LSOA level&\multirow{1}{*}{$768.974$}&\multirow{1}{*}{$1.000$}&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}\\%ha is a symbol for hectares
  \\
\vspace{-0.345cm}People per mill. km\textsuperscript{2}-LAD level&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}&\multirow{1}{*}{$594.369$}&\multirow{1}{*}{$1.000$}%ha is a symbol for hectares
  \\  \\
\vspace{-0.345cm}Climate knowledge&$0.020$&$1.000$&$0.556$&$1.000$\\
  ...
  \vspace{-0.345cm}How much is tax gas and el.\small{(\textsterling~/yr.)}&$0.252$&$\small{<}2\times10^{-8}~^{***}$&$0.251$&$\small{<}2\times10^{-8}~^{***}$\\
    ...
    \vspace{-0.345cm}Climate seriousness perception&$7.158$&$\small{<2\times10^{-8}}~^{***}$&$7.282$&$\small{<}2\times10^{-8}~^{***}$\\
      \\
\vspace{-0.345cm}Social val. orientation (ring meas.)&\multirow{1}{*}{$0.048$}&\multirow{1}{*}{$1.000$}&\multirow{1}{*}{$0.009$}&\multirow{1}{*}{$1.000$}\\ % ring measure> ref working paper dolton tol     
...
% soubor FuelGas4cp.R a %.FuelGas4bInOut.R % soubor FuelGas5cp.R  %.FuelGas4bInOut4.R
\label{FuelInOut} 
\centering
\begin{small}
\vspace{-0.8cm}
...
\\
\hline
  \multicolumn{1}{l}{}&\multicolumn{2}{c}{\textbf{Model} $\boldsymbol{1}$}% FuelGas4cp.R
  &\multicolumn{2}{c}{\textbf{Model} $\boldsymbol{2}$}\\%.FuelGas4bInOut.R
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
  \multicolumn{1}{l}{} & \multicolumn{1}{c}{\textbf{Aggreg.}}& \multicolumn{1}{c}{\textbf{Aggreg.}}& \multicolumn{1}{c}{\textbf{Aggreg.}} &  \multicolumn{1}{c}{\textbf{Aggreg.}} \\
...
\hspace{0.6cm}questions $(0/1)$&& &\\
\hline \vspace{-0.3cm}\\
\vspace{-0.32cm}Income - predicted (thousands \textsterling~/yr.)&\multicolumn{2}{c}{\textit{Not included}}&$88.788$&$0.344$ \\ %income PREDICTED!!
  \\
\vspace{-0.32cm}Net assets (million pounds \textsterling)&\multicolumn{2}{c}{\textit{Not included}}&$3.168$&$0.936$\\ 
      \\
\vspace{-0.32cm}People per mill. km\textsuperscript{2} - LSOA level&\multicolumn{2}{c}{\multirow{1}{*}{\textit{Not included}}}&\multirow{1}{*}{$43.595$}&\multirow{1}{*}{$1.000$}\\%ha is a symbol for hectares
  \\
...
% with regard to climate knowledge?? but also relevant for climate concern...

%Another important question is, what actually is 'scientific consensus'? \citet{Cook2013COnsensus} and \citet{Kahan2015} argue, that an opinion or a position, which is agreed on by most articles on a given topic published in peer-reviewed scientific journals is a scientific consensus. But is scientific consensus actually the best available evidence or a theory which is closest to absolute objective truth? Is it reasonable to assume that individuals with high degree of numeracy, analytical reasoning and scientific literacy will tend to believe to the scientific consensus, if considered from purely objective point of view, independently of what stance toward the topic (in our case climate change) express their identity? Publication bias casts doubt on this assumption. Publication bias typically occurs when a result of a study affects the decision whether to publish the results or not. In particular, it can arise if there is a preference to publish statistically significant results, which is usually the case. Therefore, every average or counts of significant versus insignificant studies is likely to be biased and misleading \citep{PubBias}. \citet{Cook2013COnsensus} review abstracts of nearly $12000$ scientific articles about global climate change published in peer-reviewed journals during period $1991-2011$. \citet{Cook2013COnsensus} argue that $64.6\%$ of these abstracts express no position on anthropogenic global warming and among the rest of them, $97.1\%$ agree that global warming is caused by humans. Hence, anthropogenic global warming is a scientific consensus. However, the scientific consensus does not take into account publication bias, therefore the results can be biased.`
