...
\vspace{-0.2cm}Intercept&$0.158$&$0.086^{\bullet}$\\
  \\
\vspace{-0.2cm}Precipitation total&$0.066$&$0.008^{**}$\\
  \\
  \vspace{-0.2cm}Precipitation total sq.&$-0.006$&$0.861$\\
  \\
  \vspace{-0.2cm}Temperature - average&$-0.036$&$0.292$\\
  \\
    \vspace{-0.2cm}Precipitation $\times$ temperature& $-0.081$&$0.008^{**}$\\
  \\
  
      \vspace{-0.2cm}Prec. c. of variation&$0.081$&$0.056^{\bullet}$\\
  \\
        \vspace{-0.2cm}Temp. std. d.&$0.108$&$0.009^{**}$\\
  \\
  \hline
\vspace{-0.2cm} \\
