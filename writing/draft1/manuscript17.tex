...
\begin{abstract}
\noindent This paper contributes to better understanding of effects of drought on food security in Kenya which should lead to improving of early warning systems and food security. Our dataset consists of yearly panel of $47$ counties of Kenya describing the period of 1981-2017.
\\
...
Before beginning our research, we had to answer the following two questions: `How should we measure food security?' and `How should we measure drought?' Based on previous literature and data availability, there are three main approaches of how to measure food security. These include agricultural crop yields (see literature overview in Sections~\ref{Introduction} and further in this section), food prices or health or utility indicators. The relevant studies focused on food prices 
were used to estimate relationship between sea surface temperature and commodity prices in tropics
...
\cite{brown2014book}: global, food prices and so \\
\cite{BROWN2015} Weather and international price shocks on food prices in the developing world.  Markets in Africa, South Asia, Latin America (regions that contain large segments of poor) \\
\cite{OxfamIDS}: GLOBE, CGE sub-Saharan Africa, central America north Africa, other low-income countries selected by OXFAM  \\
\cite{robinson2010}   Implications of food production and price shocks welfare in Ethiopia: a general equilibrium analysis CGE \\
\cite{Ubilava2018}: Estimate relationship between sea surface temperature and commodity prices using. tropics?? not sure about geographic focus entirely...
