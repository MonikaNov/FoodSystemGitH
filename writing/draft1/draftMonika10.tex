...
\section{Conclusion}\label{Conclusion}
	...
	\begin{itemize}
	\item[$\boldsymbol{\rightarrow}$] We can stress the importance of focusing the forecast on the climate characteristics (or measures) which we find significant in our models
\end{itemize}
