...
To the best of our knowledge, this is the first study which has applied linear mixed effects models to estimates effects of precipitation and agriculture on crop yields in Kenya. Mixed effects models are suitable for analysis of panel data as they account for the panel structure of the dataset. That is, the relationship of yield and weather is likely to differ across counties. To the best of our knowledge, this is also the first study which has utilised as comprehensive weather dataset as we have used: the frequency of our weather data was daily and the resolution: \textcolor{red}{\textbf{!!!}} 
