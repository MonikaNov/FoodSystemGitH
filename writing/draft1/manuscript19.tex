...
questions: `How should we measure food security?' and `How should we measure drought?' Taking into account previous literature and data availability, we considered three main approaches to measuring food security. These include using food prices, health and utility indicators or agricultural crop yields as measures of food security. Unfortunately, we had to exclude the health and utility indicators because of data availability issues. Although some health and utility indicators, such as Mid Upper Arm Circumference (MUAC) of children under five, the Coping Strategies Index (\citealp{CSI}) or the early warning phases are available in the NDMA Early Warning Bulletins, they are only available since mid $2013$. Furthermore, the scales do not seem to be consistent over all counties and frequently the values are not present at all. The relevant studies focused on food prices include \cite{Ubilava2018}, who has estimated relationship between sea surface temperature and commodity prices in tropics, \cite{robinson2010} who analysed implications of food production and price shocks welfare in Ethiopia or \cite{OxfamIDS} who have focused on sub-Saharan Africa, central America north Africa and other low-income countries selected by OXFAM. \cite{brown2014book} and \cite{BROWN2015} have developed a quantitative models to investigate relationship of  weather and international price shocks on food prices in the developing world. \textcolor{red}{or the disadvantage of using pricess is..}We, however, decided not to use food prices as a measure of food security because prices are usually strongly spatially autocorrelated across counties and this could cause the regression estimates to be inconsistent and inefficient unless taking into account the spatial autocorrelation structure. Modelling the structure of spatial autocorrelation would require developing and estimation of complicated structural equations and additional data which may not be available.  Therefore we opted for a \textcolor{red}{single} reduced form equation with crop yields as the dependent variable.  We have provided a broad overview of literature concerned with agricultural yields in Sections~\ref{Introduction} and further in this section.
