...
Before we started our research, we had to answer the following questions: `How should we measure food security?' And `How should we measure drought?' To answer the first question, the measure which has been used as a proxy for food security in the literature are as follows:\\
