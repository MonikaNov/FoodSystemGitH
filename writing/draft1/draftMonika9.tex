...
\item Tables of estimates of:

\begin{enumerate}
\item Basic model which only includes seasonal precipitation and average seasonal temperature
...
\end{enumerate}
\item Verbal description and interpretation of the results in table
\item Discussion and Conclusion:
	\begin{itemize}
	\item Stressing the importance of not only focusing on prediction of rain totals, but also other characteristics of the weather - particularly the variables found significant
	\end{itemize}
