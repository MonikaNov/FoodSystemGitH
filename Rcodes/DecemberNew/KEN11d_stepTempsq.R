...
fullishML<-lme(log(Yield0)~SeasPr+AvgTemp+I(SeasPr^2)+I(AvgTemp^2)+ Prec2m+CVPrec+Spell+Spell4 +MaxP
...
fullish_lmer<-lmer(log(Yield0)~SeasPr+AvgTemp+I(SeasPr^2)+I(AvgTemp^2)+I(AvgTemp^2)+ Prec2m+CVPrec+Spell+Spell4 +MaxP
...
summary(get_model(Cary_step_full));vif(get_model(Cary_step_full))  # navic je tu MaxT a chybi spells....> tak zkusim ban maxT:MA vysoke VIF..
  full_lmer2<-lmer(log(Yield0)~SeasPr+AvgTemp+I(SeasPr^2)+ Prec2m+CVPrec+Spell+Spell4 +MaxP
                  + CVTempK + DDays +HWDays+(1|ID1),data=ScaledTS) 
    Cary_step_full2<-step(full_lmer2, keep=attr(terms(full_lmer2), "term.labels")[1:3])
    summary(get_model(Cary_step_full2)) #..>>>--------COOL, VERY GOOD-------<<<<.
...
#oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
save.image("Rcodes/DecemberNew/KEN11d_stepNicePlaying.RData")