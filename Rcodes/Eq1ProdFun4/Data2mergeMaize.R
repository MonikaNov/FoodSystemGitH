...
CrMaize16<-droplevels(subset(CrMaize15, Year %in% 2000:2014, select=c("ID","county","Year","Yield","MT","Area","west1")))
...
lapply( unique(climate13[[1]]$ID1),  function(j){
                            
                            casted<-cast(  subset(climate13[[1]],ID1==j), Year~Month,value=names(climate13[[1]])[5]  )
                            rounded<-round(casted,3)
                            sapply(2:13,function(i) {any(duplicated(rounded[i]))  }     )}
)
...
repeats<-sapply( unique(climate13[[v]]$ID1),  function(j){
  
  casted<-cast(  subset(climate13[[v]],ID1==j), Year~Month,value=names(climate13[[v]])[5]  )
  rounded<-round(casted,3)
  sapply(2:13,function(i) {sum(any(duplicated(rounded[i])))  }     )}
)


which(rowSums(repeats)>0)
which(repeats>0,arr.ind=TRUE)



for (i in 1:  nrow(   which( repeats>0,arr.ind=TRUE)) )
{ k<-  which(repeats>0,arr.ind=TRUE)[i,2]
l<-unique(climate13[[4]]$ID1)[k]
j <- which(repeats>0,arr.ind=TRUE)[i,1]

if (length(which(duplicated(round(cast(  subset(climate13[[v]],ID1==l), Year~Month,value=names(climate13[[v]])[5]  ),3)[j+1])))>2)

{
print(round(cast(  subset(climate13[[v]],ID1==l), Year~Month,value=names(climate13[[v]])[5]  ),3)[j+1])
print(which(duplicated(round(cast(  subset(climate13[[v]],ID1==l), Year~Month,value=names(climate13[[v]])[5]  ),3)[j+1]))) }}
...
#oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
#oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
rm(list=setdiff(ls(), "CrMaize15"))
save.image("Main/CrMaize15.RData")
