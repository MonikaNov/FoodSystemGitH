...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# for anova ML is better:
KEN11aML<-update(KEN11a,.~.,method="ML");summary(KEN11aML)
KEN11a_ASAL_ML<-update(KEN11a_ASAL,.~.,method="ML");summary(KEN11a_ASAL_ML)
KEN11a_nonASAL_ML<-update(KEN11a_nonASAL,.~.,method="ML");summary(KEN11a_nonASAL_ML)