...
Kalinda<-step(fullish, ddf = c("Satterthwaite"), keep=attr(terms(fullish), "term.labels")[1:3])
summary(get_model(Kalinda))  # ehm..unexpectedly fast...

Cary<-step(fullish, ddf = c("Satterthwaite"), keep=attr(terms(fullish), "term.labels")[1:2])
