...
plot(Amelie40ln)
plot(Amelie40ln,type=c("p","smooth")) # maybe remove the extreme resid obervation???
plot(Amelie40ln,sqrt(abs(resid(.)))~fitted(.), type=c("p","smooth"))
qqmath(Amelie40ln,id=0.05)
# and not scaled 
...
plot(Lie40ln)
plot(Lie40ln,type=c("p","smooth")) # maybe remove the extreme resid obervation???
plot(Lie40ln,sqrt(abs(resid(.)))~fitted(.), type=c("p","smooth"))
qqmath(Lie40ln,id=0.05)
