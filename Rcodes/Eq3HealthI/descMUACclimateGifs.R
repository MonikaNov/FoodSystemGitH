...
sapply(1:54,function(x)  cor.test(lag(Phase22ts$PreMean,k=x),Phase22ts$MUACn)[[3]])
...
{plot(Phase22ts$MUACn,lag(Phase22ts$PreMean,k=i),main=" ")  
 ...
 # Sys.sleep(1.5)
  dev.copy(jpeg,filename=paste("/its/home/mn301/foodSystems/Rcodes/Eq3HealthI/plotsG/plot",i,".jpg",sep=""))
  dev.off ();
}
par(mfrow=c(1,1),mar=c(5.1,4.1,4.1,2.1))
