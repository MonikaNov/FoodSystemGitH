...
load("~/foodSystems/Rcodes/NewClimateSept/Models2.RData")
...
base<-MaizeClimateScTS[c( "ID1","ADM2_NAME","Year","ASAL","MaxTemp_OctMar","AvgTemp_OctMar","CumDD_OctMar","HeatWDays_OctMar",
...
Cassey2<-lmer(Yield~MaxTemp_OctMar+AvgTemp_OctMar+CumDD_OctMar+HeatWDays_OctMar+
                SDtemp_OctMar+MaxTemp_MarSep+AvgTemp_MarSep+CumDD_MarSep+HeatWDays_MarSep+SDtemp_MarSep+PrecCoefVar_OND+
         DrSpell10_OND+DrSpell20_OND+DrySpell_OND+MaxRain_OND+SeasRain_OND+Prec2Months_OND+PrecCoefVar_MAM+
 DrSpell10_MAM+DrSpell20_MAM+DrySpell_MAM+MaxRain_MAM+SeasRain_MAM+Prec2Months_MAM+
   ( MaxTemp_OctMar+AvgTemp_OctMar+CumDD_OctMar+HeatWDays_OctMar+
       SDtemp_OctMar+MaxTemp_MarSep+AvgTemp_MarSep+CumDD_MarSep+HeatWDays_MarSep+SDtemp_MarSep+PrecCoefVar_OND+
       DrSpell10_OND+DrSpell20_OND+DrySpell_OND+MaxRain_OND+SeasRain_OND+Prec2Months_OND+PrecCoefVar_MAM+
       DrSpell10_MAM+DrSpell20_MAM+DrySpell_MAM+MaxRain_MAM+SeasRain_MAM+Prec2Months_MAM |ID1),  data=base)
summary(Cassey2) 
...
Cassey2<-lmer(Yield~MaxTemp_OctMar+AvgTemp_OctMar+CumDD_OctMar+HeatWDays_OctMar+
                ...
                DrSpell10_OND+DrSpell20_OND+DrySpell_OND+MaxRain_OND+SeasRain_OND+Prec2Months_OND+PrecCoefVar_MAM+
                DrSpell10_MAM+DrSpell20_MAM+DrySpell_MAM+MaxRain_MAM+SeasRain_MAM+Prec2Months_MAM+
                ( AvgTemp_OctMar+CumDD_OctMar+HeatWDays_OctMar+
                   AvgTemp_MarSep+CumDD_MarSep+HeatWDays_MarSep+
                  DrySpell_OND+MaxRain_OND+SeasRain_OND+
                   DrySpell_MAM+MaxRain_MAM+SeasRain_MAM |ID1),  data=base)
summary(Cassey2) 
