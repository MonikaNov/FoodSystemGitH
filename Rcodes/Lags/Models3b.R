...
Peggy3<-lmer(Yield ~ I((SeasRain_MAM_L1+SeasRain_OND_L1)*(1-west1))
             +I(AvgTemp_MarSep_L1*west1)  +I(AvgTemp_MarSep_L1*(1-west1)) 
             
             +I(SDtemp_OctMar_L1*west1)   +I(SDtemp_OctMar_L1*(1-west1)) 
             
             +  I(HeatWDays_MarSep_L1*west1) + I(HeatWDays_MarSep_L1*(1-west1)) +I(HeatWDays_MarSep_L1^2)
             + I( (HeatWDays_MarSep_L1*(1-west1))^2 )
