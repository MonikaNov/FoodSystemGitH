...
scale(CrMaize16$PreMed)[CrMaize16ts$ID==4 & CrMaize16ts$Year==2000]
...
scale(CrMaize16$TemMed)[CrMaize16ts$ID==4 & CrMaize16ts$Year==2000]
scale(CrMaize16$TemMed, center = FALSE)[CrMaize16ts$ID==4 & CrMaize16ts$Year==2000]
0.9948118^2
...
#-----------------------------------------------------------------------------------------------------------------------
  par(mar=c(1,2.5,3.5,1))
  barplot(c(y1,y2,y3)-0.3,axes=FALSE,ylab=("Yield, tonnesper hectare"),main=" Muranga'a, 2000 ")
axis(2, at=seq(0, 0.6, 0.1), labels=c("0.3","0.4","0.5","0.6","0.7","0.9","1")) 

legend(0.08,0.28,legend = c("Weather as observed"),text.col=c("black")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")

legend(0.08,0.23,legend = c("Precipitation = 61.9 ml"),cex=1,text.col=c("blue")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")
legend(0.08,0.18,legend = c("Temperature = 28.99C°"),cex=1,text.col=c("red")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")
legend(1.28,0.23,legend = c("Precipitation: +30%"),cex=1,text.col=c("blue")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")
legend(2.52,0.39,legend = c("Precipitation: +30%"),cex=1,text.col=c("blue")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")
legend(2.52,0.29,legend = c("Temperature: +0.4C°"),cex=1,text.col=c("red")
       ,bg="beige",box.col="white",pt.cex=0.1,pt.lwd=0,bty="n")
